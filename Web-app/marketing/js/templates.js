...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* ==========================================
       ...
       - This would redirect to the app dashboard
       - Pass the selected template ID as a query parameter
  ...
  applyButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      console.log(`User clicked: Use Template "${templateName}"`);
      ...
      /* ==========================================
               ...
               1. Redirect to dashboard with template pre-selected
               2. Track analytics event
               
               Example:
               window.location.href = `/dashboard?template=${encodeURIComponent(templateName)}`;
               ========================================== */
    });
  });
