# Razorpay Setup Guide for Amarika
...
3. Secret: Create a secret string (e.g., `amarika_secret`)
4. Save this secret: `firebase functions:config:set razorpay.webhook_secret="amarika_secret"`
5. Select events:
